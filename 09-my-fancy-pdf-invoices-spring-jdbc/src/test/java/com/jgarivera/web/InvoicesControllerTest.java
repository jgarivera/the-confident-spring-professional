...
// Assume the persistence layer is working and just test the service layer instead
// Reference: https://docs.spring.io/spring-framework/reference/testing/testcontext-framework/tx.html

// Further studying is required because there are opinions against using @Transactional in tests
@Transactional
